...
COS_API_KEY_ID="q0HycFoj-9OS1xXiNqNAXxwjG3FfmZb3QszbozNucaOd"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/4e47adc1a4fa432bbb7762a5720ac082:3483da13-0572-42a8-ac76-87db467af039::"
...
@app.route('/')
def index():
    files = get_bucket_contents('ibmnalaiyathiran')
